In this project we will create a catalog management application (product, category, etc.) with a javaFx graphical interface using SceneBuilder, using the three-layer architector:
